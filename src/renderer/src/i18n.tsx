...
const en: Dict = {
  ...
  'settings.brand': 'SlideWeb · Settings',
  ...
  'settings.theme.desc': 'Choose the app appearance.',
  ...
  'settings.autoHide.name': 'Hide on blur',
  'settings.autoHide.desc': 'Hide the panel when SlideWeb loses focus.',
  'settings.autoHide.on': 'On',
  'settings.autoHide.off': 'Off',
  ...
  'settings.update.available': 'SlideWeb v{version} is available.',
  'settings.update.notAvailable': 'You are already on the latest version.',
  'settings.update.downloading': 'Downloading... {percent}%',
  'settings.update.downloaded': 'SlideWeb v{version} is ready to install.',
...
const zh: Dict = {
  ...
  'settings.autoHide.name': '失焦自动隐藏',
  'settings.autoHide.desc': '点击到应用外、焦点离开 SlideWeb 后自动隐藏侧边栏。',
  'settings.autoHide.on': '开启',
  'settings.autoHide.off': '关闭',
  ...
  'settings.update.available': '发现 SlideWeb v{version}。',
  'settings.update.notAvailable': '当前已经是最新版本。',
  'settings.update.downloading': '正在下载... {percent}%',
  'settings.update.downloaded': 'SlideWeb v{version} 已下载，可以安装。',
